                  ...
                  <?php
                    ...
                    if(isset($_POST['view'])){
                       ...
                       if($type == "1"){ //All Attendance
                        ...
                        tblclassYears.classYearName,tblsessionterm.sessionName,tblsessionterm.termId,tblterm.termName,
                        ...
                        where tblattendance.admissionNo = '$admissionNumber' and tblattendance.classId = '$_SESSION[classId]' and tblattendance.classYearId = '$_SESSION[classYearId]'";
                       ...
                       if($type == "2"){ //Single Date Attendance
                        ...
                        INNER JOIN tblterm ON tblterm.Id = tblsessionterm.termId
                        INNER JOIN tblstudents ON tblstudents.admissionNumber = tblattendance.admissionNo
                        where tblattendance.dateTimeTaken = '$singleDate' and tblattendance.admissionNo = '$admissionNumber' and tblattendance.classId = '$_SESSION[classId]' and tblattendance.classYearId = '$_SESSION[classYearId]'";
                       ...
                       if($type == "3"){ //Date Range Attendance
                        ...
                        INNER JOIN tblterm ON tblterm.Id = tblsessionterm.termId
                        INNER JOIN tblstudents ON tblstudents.admissionNumber = tblattendance.admissionNo
                        where tblattendance.dateTimeTaken between '$fromDate' and '$toDate' and tblattendance.admissionNo = '$admissionNumber' and tblattendance.classId = '$_SESSION[classId]' and tblattendance.classYearId = '$_SESSION[classYearId]'";
