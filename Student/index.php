    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <?php 
$query1=mysqli_query($conn,"SELECT * from tblstudents where classId = '$_SESSION[classId]' and classYearId = '$_SESSION[classYearId]'");                       
...
?>
            ...
            <!-- Earnings (Annual) Card Example -->
             <?php 
$query1=mysqli_query($conn,"SELECT * from tblclassYears");                       
$classYears = mysqli_num_rows($query1);
?>
            <div class="col-xl-3 col-md-6 mb-4">
              <a href="viewAttendance.php">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Class Years</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $classYears;?></div>
                      <div class="mt-2 mb-0 text-muted text-xs">
            ...
            <?php 
$query1=mysqli_query($conn,"SELECT * from tblattendance where classId = '$_SESSION[classId]' and classYearId = '$_SESSION[classYearId]'");                       
