                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="subjectName" value="<?php echo isset($row['subjectName']) ? $row['subjectName'] : ''; ?>" id="exampleInputFirstName" placeholder="Subject Name">
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
