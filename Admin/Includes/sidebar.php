 <ul class="navbar-nav sidebar sidebar-light accordion " id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center bg-gradient-primary  justify-content-center" href="index.php">
        <div class="sidebar-brand-icon" >
          <img src="https://www.shutterstock.com/image-vector/effective-teamwork-icon-black-thin-600nw-2227180861.jpg">
        </div>
        <div class="sidebar-brand-text mx-3">ECE STUDENT ATTENDANCE </div>
      </a>
      ...
      <div class="sidebar-heading">
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" href="viewStudents.php" data-toggle="collapse" data-target="#collapseBootstrap2"
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrapusers"
          ...
          <span>Manage Class Years</span>
        </a>
        <div id="collapseBootstrapusers" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Manage Class Years</h6>
            <a class="collapse-item" href="createClassYear.php">Create Class Years</a>
      ...
      <div class="sidebar-heading">
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" href="createSubject.php" 
          aria-expanded="true" aria-controls="collapseBootstrap2">
