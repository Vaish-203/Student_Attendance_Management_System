...
<head>
  ...
  <title>Attendence System - Login</title>
...
<body class="bg-gradient-login" style="background-image: url('home1.jpg');">
  <!-- Login Content FOR ATTENDENCE -->
              ...
              <div class="col-lg-12">
                ...
                <h5 align="center">STUDENT ATTENDANCE SYSTEM</h5>
                  <div class="text-center">
                    <img src="https://play-lh.googleusercontent.com/x5B2yHE7FgoLO0JkqtMcnc2yl6WdRhSUsEOtl4Eei1WT9VIVkFURRt4AgIHlgv6Urdg" style="width:100px;height:100px">
                    <br><br>
  ...
  if(isset($_POST['login'])){
    ...
    if($userType == "Administrator"){
      ...
      if($num > 0){
        ...
        $_SESSION['classYearId'] = $rows['classYearId'];
